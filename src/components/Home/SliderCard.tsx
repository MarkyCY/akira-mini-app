    ...
    return (
        <div className="space-y-3 w-[200px] rounded-[13px] shadow bg-white border border-gray-200 dark:bg-neutral-900 dark:border-neutral-900">
            ...
            <div className="space-y-1 text-sm px-4 pb-4">
                <h3 className="pb-1 text-base font-medium leading-none text-black dark:text-white">Secretos del Oricalco</h3>
                <p className="text-sm text-muted-foreground text-neutral-700 dark:text-neutral-400">Hoy veremos todos los secretos del oricalco en vivo y en directo.</p>
                <div>
                    <a href="#" className="inline-flex items-center text-xs font-normal text-gray-500 hover:underline dark:text-neutral-300">
                        2 days incoming
                    </a>
                </div>
            </div>
