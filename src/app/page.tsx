              ...
              <div className="space-y-3 w-[200px] rounded-[13px] shadow bg-white border border-gray-200 dark:bg-neutral-900 dark:border-neutral-900">
                <span data-state="closed">
                  <div className="overflow-hidden rounded-t-[12px] h-28 w-full animate-pulse">
                    <div className="flex items-center justify-center object-cover rounded-t-[12px] bg-gray-300 dark:bg-gray-500 h-full w-full">
                      <svg className="w-10 h-10 text-gray-200 dark:text-neutral-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                ...
                <div className="space-y-2 text-sm px-4 pb-4">
                  <h3 className="text-base font-medium leading-none text-black dark:text-white animate-pulse bg-gray-300 dark:bg-gray-500 h-4 w-3/4 rounded"></h3>
                  <p className="text-sm text-muted-foreground text-neutral-700 dark:text-neutral-400 animate-pulse bg-gray-300 dark:bg-gray-500 h-2 w-4/5 rounded"></p>
                  <p className="text-sm text-muted-foreground text-neutral-700 dark:text-neutral-400 animate-pulse bg-gray-300 dark:bg-gray-500 h-2 w-1/2 rounded"></p>
                </div>
              </div>
